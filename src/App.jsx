...
const firebaseConfig = {
  apiKey: import.meta.env.ENV_API_KEY,
  authDomain: import.meta.env.ENV_AUTH_DOMAIN,
  projectId: import.meta.env.ENV_PROJECT_ID,
  storageBucket: import.meta.env.ENV_STORAGE_BUCKET,
  messagingSenderId: import.meta.env.ENV_MESSAGING_SENDER_ID,
  appId: import.meta.env.ENV_APP_ID
};

const app = initializeApp(firebaseConfig);
const auth = getAuth(app);
const db = getFirestore(app);
const appId = "my-macro-tracker";
